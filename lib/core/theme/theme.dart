...
ThemeData lightMode = ThemeData(
  ...
  colorScheme: const ColorScheme.light(
    ...
    surface: Color.fromARGB(
      ...
      245,
      245,
    ), // Te gjitha backgroundet kryesore
    inversePrimary: Color.fromARGB(
      255,
      255,
      255,
      255,
    ), // Per navigation bottom bar e kom perdor
    ...
    surfaceTint: Color.fromARGB(
      255,
      255,
      229,
      169,
    ), // Per modal overlay app bar
...
ThemeData darkMode = ThemeData(
  ...
  colorScheme: const ColorScheme.dark(
    ...
    tertiary: Color.fromARGB(
      ...
      255,
      255,
    ), // Per reverse icon ne exercise detail
